here::i_am("Code/6 Additional Plots.R")
library(here)
library(ggplot2)
library(tidyverse)
...
# Set up df as was done for mNDP
...
######## Combine levels - must be run after 5 Posterior Co-Clustering.R########
...
# Assign observational cluster within population cluster (different method to what was included in thesis)
for(i in 1:max(cell_comb_clust$Pop_clust)){
